...
public class IPMultiblockProperties implements ClientMultiblocks.MultiblockManualData{
	...
	public NonNullList<ItemStack> getTotalMaterials(){
		...
		//@formatter:off
		final List<StructureTemplate.StructureBlockInfo> structure = this.multiblock.getStructure(MCUtil.getLevel());
